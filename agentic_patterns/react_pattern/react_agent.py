# --- START OF agentic_patterns/react_pattern/react_agent.py (LLM Service Strategy) ---
...
# No longer importing Groq client directly here
# from groq import AsyncGroq

# Import the LLM Service Interface and Standardized Response
from agentic_patterns.llm_services.base import LLMServiceInterface, StandardizedLLMResponse, LLMToolCall
# Local Tool imports
from agentic_patterns.tool_pattern.tool import Tool
# MCP Client imports
from agentic_patterns.mcp_client.client import MCPClientManager, SseServerConfig
# Utils imports
from agentic_patterns.utils.completions import build_prompt_structure, ChatHistory, update_chat_history
# Import MCP types for tool schema translation
from mcp import types as mcp_types


load_dotenv()

# Keep the prefix-based prompt
CORE_SYSTEM_PROMPT = """
...
class ReactAgent:
    ...
    def __init__(
        self,
        # --- Changed: Accepts LLMServiceInterface instead of model string ---
        ...
        # --- Changed: Store the service instance ---
    ...
    # --- _get_combined_tool_schemas remains the same ---
    ...
    # --- process_tool_calls and _execute_single_tool_call remain the same ---
    ...
    # --- run method modified to use self.llm_service ---
    async def run(
        self,
        user_msg: str,
        max_rounds: int = 5,
        ...
        for round_num in range(max_rounds):
            ...
            # --- Changed: Use self.llm_service.get_llm_response ---
            ...
            if assistant_content is not None:
                 # --- Prefix parsing logic remains the same ---
                 lines = assistant_content.strip().split('\n')
                 # ... (prefix parsing logic as before) ...
                 thought_lines = []
                 response_lines = []
                 in_thought = False
                 in_response = False
            ...
            # --- Update History: Construct message dict from standardized response ---
            ...
            # Translate standardized tool calls back to API format if needed for history
            ...
            # --- Check for Final Response (logic remains mostly same) ---
                ...
                return final_response
                 ...
                 # Use the raw content if no prefix found
        ...
        # --- Max rounds reached logic remains the same ---
...
# --- END OF agentic_patterns/react_pattern/react_agent.py (LLM Service Strategy) ---