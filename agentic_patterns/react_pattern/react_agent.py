...
- After receiving an <observation>, you MUST output a <thought> explaining how you will use the observation before generating the final <response>.
"""
        ...
        if self.tools:
            ...
            for _ in range(max_rounds):
                ...
                if thought.found and thought.content:
                    ...
                    print(Fore.YELLOW + "\nWarning: No <thought> tag found in this round.")
