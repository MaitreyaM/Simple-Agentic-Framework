# --- START OF agentic_patterns/tools/web_crawler.py (Revised - Fix Internal Call) ---
...
async def extract_text_by_query(url: str, query: str, context_size: int = 300) -> str:
    ...
    """
    try:
        # --- CORRECTED: Call .run() on the scrape_url Tool object ---
...
# --- END OF agentic_patterns/tools/web_crawler.py (Revised - Fix Internal Call) ---